...
{"label","A1ATD3"},
 {"ns","You have an appointment with Mark Carpenter at Power Planning Services.  You'd better get going!","VS_T1P3A1_01.ogg"},
 {"pg","Great, Evelyn, Thank you.","END"},
 {"pg","I have some questions about the simulation.","A14"},
{"label","A1ATD4"},
 {"ns","You should go interview the spill containment services firms that Mark Carpenter told you about.  If you've forgotten where they are located, go see Mark again. He can remind you where your vendors are located.","VS_T1P3A1_02.ogg"},
 {"pg","Thank you, Evelyn.","END"},
 {"pg","I have some questions about the simulation.","A14"},
{"label","A1ATD5"},
 {"ns","Have you found out everything you can about the spill containment services firms  you were told to research?  If you're ready to make a recommendation, go see Will Standon and he will  give you your next step. If want to conduct interviews and need to know where the vendors are located, go see Mark Carpenter.","VS_T1P3A1_03.ogg"},
 {"pg","Okay, Evelyn, thanks.  I am on it.","END"},
 {"pg","I have some questions about the simulation.","A14"},
{"label","A1ATD6"},
 {"ns","Have you informed Will Standon about your choice for a media relations firm?  The next step for you is to finalize your choice with Mayor Gonzalez at City Hall.  Remember to dress for success!","VS_T1P3A1_04.ogg"},
...
{"label","A1ATD8"},
 ...
 {"pg","I have some questions about the simulation.","A14"},
{"label","A1ATD9"},
 {"ns","Did you get your chosen spill containment services firm to sign the contract?  If not, go back to where you first met the vendor and present them with the contract for signing.","VS_T1P3A1_05.ogg"},
 {"pg","Okay, thanks!","END"},
 {"pg","I have some questions about the simulation.","A14"},
{"label","A1ATD10"},
 {"ns","You're moving right along. Did you hire a spill containment services firm?  If so, go get the contract counter-signed by Mayor Gonzalez!  She is waiting for you at City Hall.  Remember to wear your business clothes!","VS_T1P3A1_06.ogg"},
 {"pg","Okay, thanks!","END"},
 {"pg","I have some questions about the simulation.","A14"},
{"label","A1ATD11"},
 ...
 {"pg","I have some questions about the simulation.","A14"},
{"label","A1ATD12"},
 {"ns","Congratulations!  The task you have been assigned has been completed!  Now, go have some fun!  You may want to look around New City for people who can use your help.  You might find it rewarding!","VS_T1PXA1_09.ogg"},
...
{"label","A15A"},
 {"ns","The object of this program  is to guide New City through this environmental disaster by successfully executing your tasks. The team that gets the best results wins!  Also, the sponsor of this simulation is going to make a real donation to an environmental advocacy organization on behalf of the winning team, so you can make a difference in the real world if you do a good job!","VS_T1toT2PXA1_11.ogg"},
