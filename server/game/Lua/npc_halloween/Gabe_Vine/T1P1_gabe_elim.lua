...
{"label","VB1ASD1"},
 {"ns","Excuse me, do I know you????????","VS_T1P1VB1_10.ogg"},
...
--****************
	...
	{"label","VB11A"},
	 ...
	 {"pg","There has been an oil spill in the New City River, and because you have experience both in town and around the State, I think the City could use your help.","VB11B"},
	 {"pg","There has been an oil spill in the New City river, and the City needs help-although I am concerned about your recent legal troubles.","VB11C"},
	...
	{"label","VB12A"},
	 ...
	 {"pg","My understanding is that you used to work at Ubik & Wittus and so you have exactly the kind of experience we need for this.","VB12B"},
	 {"pg","Well I hear that you are skilled at communicating complicated messages to the overall public.","VB12C"},
	...
	{"fun", incinterv},
	 ...
	 {"pg","Yes, but I have some research to do. In the meantime, please consider that this is a crisis – and you will help us by only charging for what is absolutely necessary for the job.","VB13B"},
	 {"pg","Well, honestly, it would influence my decision to hire you if you were to decide to make some sort of donation to the clean up effort.","VB13C"},
...
--*******************
	...
	{"label","VB1ASD2A"},
	 ...
	 {"pg","You bet!  I’d love to get you on board.  What will it take?","VB1ASD2B"},
...
--*****************
	...
	{"fun3",setvar,"scoreconvo","v2"},
	 ...
	 {"pg","You bet!  I am excited considering your career has been spent in the media industry here in New City.","VB21C"},
	 {"pg","No, I am just passing through.  See you around","VB21B"},
	 {"pg","You bet!  I am excited to see what you can do for the city considering the great work you did saving Idion Energy!","VB21D"},
	 {"pg","Well, I would  hire NMC, but I’m concerned that your firm may not be able to get news out about the disaster both locally and state-wide…","VB21D"},
	...
	{"label","VB22A"},
	 ...
	 {"pg","I thought you normally charge $750 for the comic books your experts use to learn about disasters.","VB22B"},
	 {"pg","Wait – I don’t think that’s what you usually charge to print flyers and hire a team of street promoters…","VB22C"},
	 {"pg1","Let’s just make it $%d, and call it a deal.  What do you say?","VB22D","deal"},
	...
	{"fun",threequartercost},
	 ...
	 {"pg","Not only have I seen you charge less for that – the City is in crisis here.  I don’t think it’s right for you to charge for that expense at all.","VB23B"},
	 {"pg","I have seen that you normally charge $500 for that expense.  I think you are trying to charge us too much.","VB23C"},
	 {"pg1","I’ll tell you what, I’d like to hire you - but I’m afraid I am NOT going to pay that expense . How about we just agree to have you come on board for $%d.  What do you say?","VB23D","deal"},
	...
	{"label","VB24A"},
	 ...
	 {"pg","Now we’ve covered all your expenses – considering this is a crisis, do you think you could forgo some profit?","VB24B"},
	 {"pg","Before we go ahead with this, I just wanted to ask – are you sure you have to charge for a war room?","VB24C"},
	 {"pg1","You know, given that this is a crisis, I think you are taking advantage of the City by charging $%d.","VB24D","cost"},
	...
	{"label","VB25A"},
	 ...
	 {"pg","Well, I was actually thinking about your comic books expense. Don’t you think we could find it cheaper?","VB25C"},
...
-- Peter was here- forcing vendors to behave....
		...
		{"label","VB25C"},
		 ...
		 {"pg","I don’t know - I still think you’re profiting too much from a community crisis.","VB25RENEGCHECK"},
		 -- scoreb:-EW
		 -- costb:PLUS
		...
		{"fun",getvendorcontract},
		 ...
		 {"pg","I am sorry…","VB32D"},
			...
			{"fun2",incprofit,10},
			 ...
			 {"pg","I am sorry for the oversight  -- but I prefer not to take a contract from your attorney.  If it’s possible, I’d rather have Will draw up a new contract.","VB32E"},
			 {"pg","That seems fair to me.  Given my oversight, that sounds like the right thing to do...","VB32F"},
