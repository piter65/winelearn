...
--**************
	...
	{"label","S17A"},
	 ...
	 {"pgs","One hundred percent, Will. I am ready to do this.","S18","j"},
		...
		{"label","S17B"},
		-- scorea:+LA
		 {"ns","I'm sorry, things are so hectic I was probably unclear.  I need to make sure you understand that you need to meet with Heather, who will give you four ecological damage assessment providers.  Research and interview them to determine who best fits our selection guidelines.","VS_T1P4S1_06.ogg"},
	...
	{"label","S18"},
		{"fun",incexpert},
		{"fun",incevelyn},
		{"fun",incevelyn},-- peter double increment
	 ...
	 {"ns","Now, go see Heather at her loft downtown to get started.  Remember, this is your first assignment, so take it slowly and pay attention to details!  People who take the time to do things right tend to do much better in business – and in life.","VS_T1P4S1_07.ogg"},
...
{"label","S1ATD2A"},
 ...
 {"pg","Before I go, could you run those selection guidelines by me one more time?","S1ATD2B"},
	{"label","S1ATD2B"},
	 {"ns","The guidelines are that the ecological damage assessment provider you choose must be able to provide accurate, unbiased assessments. Next, the consultant must have the right equipment to monitor the damage and track our progress during the cleanup. Finally, we need to make sure the consultant is able to report findings in a clear, concise manner.","VS_T1P4S1_08.ogg"},
...
{"fun3",setvar,"scoreconvo","s2"},
 ...
 {"pg","Actually, Will, I need to hear those guidelines again.","S2ATD-1B"},
	...
	{"label","S22"},
	 ...
	 {"pgs","I'd like to go with Nostra Casa Waste Carting!","S23E","a"},
	 {"pgs","I think the New City Department of Sanitation is our best choice.","S23F","b"},
...
--**********************
	...
	{"label","S43"},
	 {"ns","That does it for your principal task, but there's plenty more to do here in New City.  There are many ways to learn, help people and make money here in New City. Take some time and have a look around to find as many opportunities as you can.\n\nIf your team members have completed this task as well, inform your teacher that your team is ready for Task 2!","VS_T1toT2PXS4_06.ogg"},
