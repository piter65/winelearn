...
{"if","msqprogress","==",1,"1A"},
{"if","msqprogress","==",2,"2D"},
{"if","msqprogress","==",3,"2D"}, -- BChance: Added extra step so that the volunteers can increase the flag as they are handled.
{"if","msqprogress","==",4,"7A"},
{"if","msqprogress","==",5,"ATD1A"},
...
{"label","7B"},
{"fun2",incvars,"msqprogress"},
{"fun2",incvars,"msq1"}, -- BChance: Added to trigger final volunteer dialogue.
{"fun2",incvars,"msq2"}, -- BChance: Added to trigger final volunteer dialogue.
{"fun2",incvars,"msq3"}, -- BChance: Added to trigger final volunteer dialogue.
{"fun2",incvars,"msq4"}, -- BChance: Added to trigger final volunteer dialogue.
