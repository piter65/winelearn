...
{"if","w1vendor","==",4,"S11C"},
		...
		{"label","S11B"},
		{"ns","Welcome back! I am glad to see you. The Mayor and I were speaking about you earlier. We both agree you are doing a fine job.  If you keep up the good work throughout your assignments here, New City will have a good shot  at  fully recovering from this crisis. Should say still room to improve?","VS_T2PXS1_02.ogg"},
	 	{"pg","That is good news, Will.  Please, continue.","S12A"},

		{"label","S11C"},
		{"ns","Welcome back! Before we begin, I just want you to know I think there is room for improvement in your work. Remember to research your vendors thoroughly and choose which one best fits our selection guidelines. Good decision-making is the key to the success for us here, and we are counting on you! ","VS_T2PXS1_03.ogg"},
	 	{"pg","I will take that into consideration and try to do better on this task, Will.","S12A"},



	{"label","S12A"},
	 {"ns","Though our critical first response is behind us, there are still important tasks to complete related to your role as Support Services Manager. Your next task is to find a logistics and support services provider who can transport and warehouse inbound relief supplies and recovery equipment. As always, the firm you choose should be the one that best fits the selection guidelines that I will give you.","VS_T2P2S1_01.ogg"},
	...
	{"label","S13A"},
	 ...
	 {"pgs","I think I have the hang of things, especially since I already completed one task successfully already, sir. ","S13BAD","d"},
	...
	{"label","S14"},
	 {"ns","The logistics and support services firm you choose must meet the following three criteria: First, they must have proven access to adequate transportation. Next, the firm you choose must have previous success coordinating and scheduling large-scale endeavors. And finally, we need to make sure our chosen firm has access to sufficient levels of storage in local warehouses.","VS_T2P2S1_02.ogg"},
	...
	{"label","S15A"},
	 {"ns","Before we conclude, let me tell you who can point you to logistics and support services firms in New City from which you can choose. His name is Willie Ketchum, and he knows a thing or two about the firms in town that can help.  He will tell you who is available.","VS_T2P2S1_03.ogg"},
	 {"pg","Okay, where can I find Willie Ketchum?","S16A"},


	{"label","S16A"},
	 {"ns","Willie Ketchum can be found in the lobby here at City Hall. When you find him, he will tell you more about local logistics and support services providers.","VS_T2P2S1_04.ogg"},
	...
	{"label","S17A"},
	 {"ns","I need to update the Mayor on our progress now, and will probably tell her about our meeting.. Would it fair to tell her that you understand what the next steps are for you to complete your task, and that everything is set to move ahead?","VS_T2PXS1_09.ogg"},
	 ...
	 {"pgs","One hundred percent, Will. I am ready to take the next steps for my task assignment.","S17BAD","j"},
		...
		{"label","S17B"},
		-- scorea:+LA
		 {"ns","I'm sorry, that was unclear. To move ahead, we have to take steps to deal with this crisis. Your next step is to meet with Willie Ketchum and then research and interview the logistics and support services that he directs you to. Determine who best fits the guidelines we went over and come back when you've made a decision.","VS_T2P2S1_05.ogg"},
	...
	{"label","S18"},
	 ...
	 {"ns","Now, go see Willie Ketchum in the lobby here at City Hall to get started.  Keep in mind, this second assignment doesn't deal with critical response like our earlier task, but the decision you make has a long-term impact none the less – so choose carefully!","VS_T2P2S1_06.ogg"},
...
{"label","S1ATD1"},
 ...
 {"pg","I understand, Will.  I will come back when I have chosen a logistics and support services firm.","END"},
...
{"label","S1ATD2A"},
 ...
 {"pg","Before I go, could you run those selection guidelines by me one more time?","S1ATD2B"},
	...
	{"label","S1ATD2B"},
	 {"ns","Of course.  Here are your vendor guidelines again: First, the logistics and services provider you choose must have proven access to adequate transportation. Next, the firm must have previous success coordinating and scheduling large-scale endeavors. And finally, we need to make sure our chosen firm has access to sufficient levels of storage in local warehouses.","VS_T2P2S1_07.ogg"},
...
{"fun3",setvar,"scoreconvo","s2"},
 {"ns","There you are!  I hope we are moving ahead with your second task. We have a crisis on our hands, and we need to move forward.  Have you decided who we should hire as a logistic and support services provider?","VS_T2P2S2_01.ogg"},
 ...
 {"pg","Actually, Will, I need to hear those guidelines again.","S2ATD-1B"},
	...
	{"label","S21B"},
	 {"ns","That concerns me, as we need to move ahead confidently.  This next task, though not a component of early disaster response, is nonetheless critical to our recovery. Look into all the available providers in town.  Come back after you've thoroughly looked into each choice.","VS_T2P2S2_02.ogg"},
	 {"pg","Alright then, Will, thanks for your time.","END"},


	{"label","S22"},
	 {"ns","So, now that you have researched your vendor choices, please tell me who you recommend to provide logistics and support services for the City's relief and recovery efforts.","VS_T2P2S2_03.ogg"},
	 {"pg","We should go with Phoenix Services Group.","S23A"},
	 {"pg","Let's go with Force One Logistics!","S23B"},
	 {"pg","I think Praire Fire Services is our best choice.","S23C"},
	 {"pg","I'd like to with Western Logistics.","S23D"},
	 {"pgs","I'd like to go with Axis Transportation and Warehousing!","S23E","a"},
	 {"pgs","I think the New City We-Haul and Mini-Storage is our best choice.","S23F","b"},


	{"label","S23A"},
	{"fun",pickedvendor1},
	 {"ns","Phoenix Services Group, okay.  Are you sure that's the best vendor available for the job?","VS_T2P2S2_04.ogg"},
	 {"pg","Yes, Will, I have selected Phoenix Services Group.  How do we get him on board now?","S24"},
	 {"pg","Actually, Will, I didn't mean Phoenix Services Group.  I'd like to make another choice.","S22"},
	 {"pg","Will, now that I think about it, I'm not really ready to make my final choice. Sorry to have wasted your time.","END"},


	{"label","S23B"},
	{"fun",pickedvendor2},
	 {"ns","Force One Logistics, that works.  Are you sure that's the best vendor available for the job?","VS_T2P2S2_05.ogg"},
	 {"pg","Yes, Will, I'd like to move forward with Force One.  What are our next steps?","S24"},
	 {"pg","Actually, Will, I didn't mean Force One.  Sorry to have wasted your time.","S22"},
	 {"pg","Will, now that I think about it, I'm not really ready to make my final choice. Sorry to have wasted your time.","END"},


	{"label","S23C"},
	{"fun",pickedvendor3},
	 {"ns","I see, Praire Fire Services Corp. Are you completely sure about this?","VS_T2P2S2_06.ogg"},
	 {"pg","I want to go with Praire Fire Servcies.  What do you think I should do next?","S24"},
	 {"pg","Actually, I didn't mean I want to go with Praire Fire.  I'd like to make another choice.","S22"},
	 {"pg","Will, now that I think about it, I'm not really ready to make my final choice. Sorry to have wasted your time.","END"},


	{"label","S23D"},
	{"fun",pickedvendor4},
	 {"ns","Western Logistics?  That's who you want to choose?","VS_T2P2S2_07.ogg"},
	 {"pg","Yes it is.  I think Western Logistics could be perfect.  Now, how do we get them on board?","S24"},
	 {"pg","Actually I changed my mind about going with Western.  I'd like to make another choice.","S22"},
	 {"pg","Will, now that I think about it, I'm not really ready to make my final choice. Sorry to have wasted your time.","END"},


	{"label","S23E"},
	-- scoree:-MR
	 {"ns","Axis Transportation and Warehousing? I thought they were on vacation! I have been trying to get them on the phone all week. You had better go and do your research to find out who is actually available.","VS_T2P2S2_08.ogg"},
	...
	{"label","S23F"},
	-- scorea:-MR
	 {"ns","You can't pick New City We-Haul and Mini-Storage! I know for a fact that they don't do this sort of thing.  I think you had better go and do your research to find out who is really available.","VS_T2P2S2_09.ogg"},
	 {"pg","Umm, right…so I guess I'll see you later then.","END"},
...
{"label","S2ATD1A"},
 {"ns","What are you doing back here?  This is an emergency, and time is of the essence!  You need to select a logistics provider to help us through this next phase of the crisis. Please get back to work immediately, and come back only when you are prepared to make a decision!","VS_T2P2S2_10.ogg"},
...
{"label","S2ATD-1B"},
 {"ns","Of course, here are your guidelines again:  First, the logistics provider you choose must have proven access to adequate transportation. Next, the firm must have previous success coordinating and scheduling large-scale endeavors. And finally, we need to make sure our chosen firm has access to sufficient levels of storage in local warehouses.","VS_T2P2S2_11.ogg"},
...
--**********************
{"label","S2ATD2"},
 {"ns","Now that you have made a decision, there is no time to waste.  Hurry back to the Mayor and let her know who you have selected so that you can get her approval and start negotiating.  If you decide to leave in something about clothing it needs to be less obvious like Event!","VS_T1toT2PXS2_03.ogg"},
...
{"label","S3ASD1"},
 ...
 {"pg","Okay, Will.  Sorry to have troubled you.","END"},
...
{"fun3",setvar,"scoreconvo","s3"},
 {"ns"," You're back.  Are you here because you've negotiated a deal and need a contract for the firm you selected to provide logistics & support services?","VS_T2P2S3_01.ogg"},
 {"pg1","Yes.  I struck a deal with %s.","S31C","vendorx"},
 {"pg","No, I'm just passing through.  See you later.","S31B"},


	{"label","S31B"},
	 {"ns","We have a crisis on our hands and there are many things that need my attention. You must excuse me, because we both have work to do. Come back after you've negotiated a deal and are ready to have me draw up a contract for you to get signed.","VS_T1toW2PXS3_01.ogg"},
	 {"pg","Sure thing, Will. Bye!","END"},


{"label","S31C"},
{"fun",getcontractcost},
 {"ns","Okay, so I just need to plug in the numbers here, and we can get this contract to you right away.  Did you arrive at a final cost for the services being provided with the logistics firm you selected?","VS_T1toW2PXS3_02.ogg"},
...
{"fun3",setvar,"shorttrap",1},
 {"ns","Okay, that sounds about right.  Just give me a second to finish this…and…here you go! The next step is to bring this contract back to the logistics firm you selected and sign them up.  You can find the contract in your inventory.  You're not allowed to lose it!","VS_T1toW2PXS3_03.ogg"},
...
{"label","S4ASD1"},
 {"ns","What are you doing here?  We need to keep moving here! You need to get that contract countersigned by the Mayor right away. Bring it back here after you are finished with her and I'll have further instructions. Are we clear?","VS_T1toT2PXS4_07.ogg"},
...
--**********************
	...
	{"label","S42A"},
		...
		{"fun2",incvars,"journalprogress"},
		{"fun3",setvar,"week_2_finished",true}, -- BChance: Flag that the week is completed.
	 ...
	 {"pgs","Understood, Will.  What's next?","S42BAD","b"},
		...
		{"label","S42B"},
		 -- scorea:+LA
		 {"ns","To have the facts you need during negotiations, you have to note everything about vendors' costs that you find during research in all the locations research is found.  Keeping costs down and getting the best deal comes down to your recall of that information.","VS_T1toT2PXS4_05.ogg"},
...
{"label","S4ATD1"},
 {"ns","Hello again. Why are you still here?  We'll be meeting again soon enough.  In the meantime, go have a look around New City. You've been told about lots of opportunites to learn, help people and make money – maybe you can make enough to buy some new clothes.\n\nIf your team members have completed this task as well, inform your teacher that your team is ready for the next Task!","VS_T1toT2PXS4_08.ogg"},
