...
{"if","w1vendor","==",4,"S11C"},
	...
	{"label","S13A"},
	 ...
	 {"pgs","I think I have the hang of things, especially since I already completed one task successfully, sir. ","S13BAD","d"},
	...
	{"label","S14"},
	 {"ns","The waste recovery and disposal provider you choose must meet the following three criteria:  First, they must have effective and efficient equipment to recover the contaminants at the site.  Next, the recovery equipment the firm uses should be environmentally friendly.  And finally, your choice must have a track record of safe hazardous waste disposal.","VS_T2P3S1_02.ogg"},
	...
	{"label","S15A"},
	 {"ns","Before we conclude, let me tell you who can point you to the local waste recovery and disposal firms from which you can choose.  He is a nobleman, Count of de Monet , but he works in the high-end lavatories supply industry, and he can tell you who in town is available.","VS_T2P3S1_03.ogg"},
	 {"pg","Okay, where can I find His Excellency, the Count de Monet?","S16A"},


	{"label","S16A"},
	 {"ns","His Excellency, the third Count de Monet, can be found in the offices of Throne Time.  His Excellency will tell you more about local waste recovery and disposal providers.","VS_T2P3S1_04.ogg"},
	...
	{"label","S17A"},
	 ...
	 {"pgs","One hundred percent, Will. I am ready to take the next steps for my task assignment.","S17BAD","j"},
		...
		{"label","S17B"},
		-- scorea:+LA
		 {"ns","I'm sorry, that was unclear.  To move ahead, we have to take steps to deal with this crisis.  Your next step is to meet with Count de Monet and then research and interview the waste recovery and disposal services provider that His Excellency will direct you to.  Determine who best fits the guidelines we went over and come back when you've made a decision.","VS_T2P3S1_05.ogg"},
	...
	{"label","S18"},
	 ...
	 {"ns","Now, go see Count de Monet at Throne Time to get started.  Keep in mind, this second assignment doesn't deal with critical response like our earlier task, but the decision you make nonetheless has a long-term impact, so choose carefully!","VS_T2P3S1_06.ogg"},
...
{"label","S1ATD1"},
 ...
 {"pg","I understand, Will.  I will come back when I have chosen a waste recovery and disposal services provider.","END"},
...
{"label","S1ATD2A"},
 ...
 {"pg","Before I go, could you run those selection guidelines by me one more time?","S1ATD2B"},
	...
	{"label","S1ATD2B"},
	 {"ns","Of course.  Here are your vendor guidelines again:  First, the waste recovery and disposal provider you choose must have effective and efficient recovery equipment.  Next, the recovery equipment the firm uses should be environmentally friendly.  And finally, your choice must have a track record of safe hazardous waste disposal.","VS_T2P3S1_07.ogg"},
...
{"fun3",setvar,"scoreconvo","s2"},
 {"ns","There you are!  I hope we are moving ahead with your second task.  We have a crisis on our hands, and we need to move forward.  Have you decided who we should hire as a waste recovery and disposal provider?","VS_T2P3S2_01.ogg"},
 ...
 {"pg","Actually, Will, I need to hear those guidelines again.","S2ATD-1B"},
	...
	{"label","S21B"},
	 {"ns","That concerns me, as we need to move ahead confidently.  This next task, though not a component of early disaster response, is nonetheless critical to our recovery.  Look into all the available waste removal providers in town.  Come back after you've thoroughly looked into each choice.","VS_T2P3S2_02.ogg"},
	 {"pg","Alright then, Will, thanks for your time.","END"},


	{"label","S22"},
	 {"ns","So, now that you have researched your vendor choices, please tell me who you recommend for a waste recovery and disposal services provider?","VS_T2P3S2_03.ogg"},
	 {"pg","We should go with Clean Green Machinery.","S23A"},
	 {"pg","Let's go with Potty Princess!","S23B"},
	 {"pg","I think West Disposal is our best choice.","S23C"},
	 {"pg","I'd like to with Dis-Po Corp.","S23D"},
	 {"pgs","I'd like to go with Axis Septic and Plumbing!","S23E","a"},
	 {"pgs","I think the Elliot County Green Rivers Alliance is our best choice.","S23F","b"},


	{"label","S23A"},
	{"fun",pickedvendor1},
	 {"ns","Clean Green Machinery, okay.  Are you sure that's the best vendor available for the job?","VS_T2P3S2_04.ogg"},
	 {"pg","Yes, Will, I have selected Clean Green Machinery.  How do we get him on board now?","S24"},
	 {"pg","Actually, Will, I didn't mean Clean Green Machinery.  I'd like to make another choice.","S22"},
	 {"pg","Will, now that I think about it, I'm not really ready to make my final choice.  Sorry to have wasted your time.","END"},


	{"label","S23B"},
	{"fun",pickedvendor2},
	 {"ns","Potty Princess, that works.  Are you sure that's the best vendor available for the job?","VS_T2P3S2_05.ogg"},
	 {"pg","Yes, Will, I'd like to move forward with Potty Princess.  What are our next steps?","S24"},
	 {"pg","Actually, Will, I didn't mean Potty Princess.  Sorry to have wasted your time.","S22"},
	 {"pg","Will, now that I think about it, I'm not really ready to make my final choice. Sorry to have wasted your time.","END"},


	{"label","S23C"},
	{"fun",pickedvendor3},
	 {"ns","I see, West Disposal Services.  Are you completely sure about this?","VS_T2P3S2_06.ogg"},
	 {"pg","I want to go with West Disposal Services.  What do you think I should do next?","S24"},
	 {"pg","Actually, I didn't mean I want to go with West Disposal.  I'd like to make another choice.","S22"},
	 {"pg","Will, now that I think about it, I'm not really ready to make my final choice. Sorry to have wasted your time.","END"},


	{"label","S23D"},
	{"fun",pickedvendor4},
	 {"ns","Dis-Po Corp?  That's who you want to choose?","VS_T2P3S2_07.ogg"},
	 {"pg","Yes it is.  I think Dis-Po Corp could be perfect.  Now, how do we get them on board?","S24"},
	 {"pg","Actually I changed my mind about going with Dis-Po.  I'd like to make another choice.","S22"},
	 {"pg","Will, now that I think about it, I'm not really ready to make my final choice. Sorry to have wasted your time.","END"},


	{"label","S23E"},
	-- scoree:-MR
	 {"ns","Axis Septic and Plumbing? I thought they were on vacation! I have been trying to get them on the phone all week. You had better go and do your research to find out who is actually available.","VS_T2P3S2_08.ogg"},
	...
	{"label","S23F"},
	-- scorea:-MR
	 {"ns","You can't pick the Elliot County Green Rivers Alliance!  I know for a fact that they don't do this sort of thing.  I think you had better go and do your research to find out who is really available.","VS_T2P3S2_09.ogg"},
	 {"pg","Umm, right…so I guess I'll see you later then.","END"},
...
{"label","S2ATD1A"},
 {"ns","What are you doing back here?  This is an emergency, and time is of the essence!  You need to select a waste recovery and disposal provider to help us through this next phase of the crisis.  Please get back to work immediately, and come back only when you are prepared to make a decision!","VS_T2P3S2_10.ogg"},
...
{"label","S2ATD-1B"},
 {"ns","Of course.  Here are your vendor guidelines again: First, the waste recovery and disposal provider you choose must have effective and efficient recovery equipment.  Next, the recovery equipment the firm uses should be environmentally friendly.  And finally, your choice must have a track record of safe hazardous waste disposal.","VS_T2P3S2_11.ogg"},
...
{"fun3",setvar,"scoreconvo","s3"},
 {"ns","You're back.  Are you here because you've negotiated a deal and need a contract for the firm you selected to provide waste recovery and disposal services?","VS_T2P3S3_01.ogg"},
...
{"label","S31C"},
{"fun",getcontractcost},
 {"ns","Okay, so I just need to plug in the numbers here, and we can get this contract to you right away  Did you arrive at a final cost for the services being provided with the waste disposal firm you selected?","VS_T1toW2PXS3_02.ogg"},
...
{"fun3",setvar,"shorttrap",1},
 {"ns","Okay, that sounds about right.  Just give me a second to finish this…and…here you go! The next step is to bring this contract back to the waste disposal firm you selected and sign them up.  You can find the contract in your inventory.  You're not allowed to lose it!","VS_T1toW2PXS3_03.ogg"},
...
--**********************
	...
	--SATISFACTORY JOB
	{"label","S41B"},
	 {"ns","Well there you are.  The Mayor tells me your task has been completed satisfactorily.  I'm happy to hear that.  There is always room for improvement, though, so try and pay attention to all the details during your research so that you can be as prepared as possible.   Make sure this is what is in the other S4's","VS_T1toT2PXS4_02.ogg"},
	...
	{"label","S42A"},
	 ...
	 {"pgs","What do you mean, “have your facts straight”? Let's change the answer response to make it less obvious","S42B","a"},
	 {"pgs","Understood, Will.  What's next?","S42BAD","b"},

		{"label","S42B"},
		 -- scorea:+LA
		 {"ns","To have the facts you need during negotiations, you have to note everything you can find out about a vendor's costs that you find during research in all the locations research is found.  Keeping costs down and getting the best deal comes down to your recall of that information. ","VS_T1toT2PXS4_05.ogg"},
...
{"label","S4ATD1"},
 ...
 {"pg","Okay, will do!  Maybe I can buy a hotdog!","END"},
