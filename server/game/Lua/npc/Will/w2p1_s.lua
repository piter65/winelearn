...
--**************
	...
	{"label","NOTYET"},
		{"n","Hello0000000. Please go talk to Evelyn at the Team Office."},
		{"pg","Okay.","END"},
...
{"if","w1vendor","==",4,"S11C"},
	...
	{"label","S12A"},
	 {"ns","Though our critical first response is behind us, there are still important tasks to complete related to your role as Media Manager. Now, your next task is to select a spokesperson that will represent the city's crisis relief and disaster recovery efforts. As always, the person you choose should be the one that best fits the selection guidelines that I will give you.","VS_T2P1S1_01.ogg"},
	...
	{"label","S14"},
	 {"ns","The spokesperson you choose must meet the following three criteria: First, they must be able to understand complex issues and events in order to communicate issues surrounding the relief and recovery efforts.  Next, our spokesperson must be able to think on his or her feet.  And finally, we need to make sure our spokesperson has a trustworthy public image.","VS_T2P1S1_02.ogg"},
	...
	{"label","S15A"},
	 {"ns","Before we conclude, let me tell you who can point you to spokespeople in New City from which you can choose. His name is D-Verb, and he is a well-known sound  engineer.  He knows a thing or two about the celebrities in town who can help, and so he will definitely know who is available.","VS_T2P1S1_03.ogg"},
	 {"pg","Okay, where can I find D-Verb?","S16A"},


	{"label","S16A"},
	 {"ns","D-Verb can be found at Hip Hop House. When you find him, he will tell you more about local spokespeople.","VS_T2P1S1_04.ogg"},
	...
	{"label","S17A"},
	 ...
	 {"pgs","One hundred percent, Will. I am ready to take the next steps for my task assignment.","S17BAD","j"},
		...
		{"label","S17B"},
		-- scorea:+LA
		 {"ns","I'm sorry, that was unclear. To move ahead, we have to take steps to deal with this crisis. Your next task is to meet with D-Verb, and then research and interview the spokespeople that he directs you to. Determine who fits the guidelines I gave you and come back when you've made a decision.","VS_T2P1S1_05.ogg"},
	...
	{"label","S18"},
	 ...
	 {"ns","Now, go see D-Verb at Hip Hop House to get started.  ","VS_T2P1S1_06.ogg"},
...
{"label","S1ATD1"},
 ...
 {"pg","I understand, Will.  I will come back when I have chosen a spokesperson.","END"},
...
{"label","S1ATD2A"},
 ...
 {"pg","Before I go, could you run those selection guidelines by me one more time?","S1ATD2B"},
	...
	{"label","S1ATD2B"},
	 {"ns","Of course.  Here are your vendor guidelines again: First, they must be able to understand complex issues and events in order to communicate issues surrounding the relief and recovery efforts.  Next, our spokesperson must be able to think on his or her feet.  And finally, we need to make sure our spokesperson has a trustworthy public image.","VS_T2P1S1_07.ogg"},
...
{"fun3",setvar,"scoreconvo","s2"},
 {"ns","There you are!  I hope we are moving ahead with your second task. We have a crisis on our hands, and we need to move forward.  Have you decided who we should hire as a public spokesperson for the City's relief and recovery efforts?","VS_T2P1S2_01.ogg"},
 {"pg","Yes, I have come to a decision about the spokesperson I think will best help us in this situation.","S22"},
 {"pg","No, I am sorry.  I don't think I am ready to decide.","S21B"},
 {"pg","Actually, Will, I need to hear those guidelines again.","S2ATD-1B"},


	{"label","S21B"},
	 {"ns","That concerns me, as we need to move ahead confidently.  This next task, though not a component of early disaster response, is nonetheless critical to our recovery. Look into all the available spokespeople in town.  Come back after you've thoroughly looked into each choice.","VS_T2P1S2_02.ogg"},
	 {"pg","Alright then, Will, thanks for your time.","END"},


	{"label","S22"},
	 {"ns","So, now that you have researched your vendor choices, please tell me who you recommend to be the spokesperson for the City's relief and recovery efforts?","VS_T2P1S2_03.ogg"},
	 {"pg","We should go with Wes Berlin","S23A"},
	 {"pg","Let's go with Lakeisha!","S23B"},
	 {"pg","I think Grandmaster G is our best choice.","S23C"},
	 {"pg","I'd like to with Fiona Rudd.","S23D"},
	 {"pgs","I'd like to go with Chet Twiddly!","S23E","a"},
	 {"pgs","I think DJ Synapse is our best choice.","S23F","b"},


	{"label","S23A"},
	{"fun",pickedvendor1},
	 {"ns","Wes Berlin, okay.  Are you sure he's the best vendor available for the job?","VS_T2P1S2_04.ogg"},
	 {"pg","Yes, Will, I have selected Wes Berlin.  How do we get him on board?","S24"},
	 {"pg","Actually, Will, I didn't mean Wes Berlin.  I'd like to make another choice.","S22"},
	 {"pg","Will, now that I think about it, I'm not really ready to make my final choice. Sorry to have wasted your time.","END"},


	{"label","S23B"},
	{"fun",pickedvendor2},
	 {"ns","Lakeisha, that works.  Are you sure she's the best vendor available for the job?","VS_T2P1S2_05.ogg"},
	 {"pg","Yes, Will, I'd like to move forward with Lakeisha.  What are our next steps?","S24"},
	 {"pg","Actually, Will, I didn't mean Lakeisha.  Sorry to have wasted your time.","S22"},
	 {"pg","Will, now that I think about it, I'm not really ready to make my final choice. Sorry to have wasted your time.","END"},


	{"label","S23C"},
	{"fun",pickedvendor3},
	 {"ns","I see, Grandmaster G. Are you completely sure about this?","VS_T2P1S2_06.ogg"},
	 {"pg","I want to go with Grandmaster G.  What do you think I should do next?","S24"},
	 {"pg","Actually, I didn't mean I want to go with Grandmaster G.  I'd like to make another choice.","S22"},
	 {"pg","Will, now that I think about it, I'm not really ready to make my final choice. Sorry to have wasted your time.","END"},


	{"label","S23D"},
	{"fun",pickedvendor4},
	 {"ns","Fiona Rudd?  That's who you want to choose?","VS_T2P1S2_07.ogg"},
	 {"pg","Yes it is.  I think Fiona Rudd could be perfect.  Now, how do we get her on board?","S24"},
	 {"pg","Actually I changed my mind about going with Fiona Rudd.  I'd like to make another choice.","S22"},
	 {"pg","Will, now that I think about it, I'm not really ready to make my final choice. Sorry to have wasted your time.","END"},


	{"label","S23E"},
	-- scoree:-MR
	 {"ns","Chet Twiddly? The Country music star? I thought he was on tour! I have been trying to get tickets for his concert in Rosenfield next month. You had better go and do your research to find out who is actually available.","VS_T2P1S2_08.ogg"},
	...
	{"label","S23F"},
	-- scorea:-MR
	 {"ns","You can't pick DJ Synapse! I know for a fact that he doesn't do this sort of thing.  I think you had better go and do your research to find out who is really available.","VS_T2P1S2_09.ogg"},
	 {"pg","Umm, right…so I guess I'll see you later then.","END"},
...
{"label","S2ATD1A"},
 {"ns","What are you doing back here?  This is an emergency, and time is of the essence!  You need to select a spokesperson to help us through this next phase of the crisis. Please get back to work immediately, and come back only when you are prepared to make a decision!","VS_T2P1S2_10.ogg"},
 ...
 {"pg","I have come to a decision about the spokesperson I think will best help us in this situation.","S22"},

{"label","S2ATD-1B"},
 {"ns","First, they must be able to understand complex issues and events in order to communicate issues surrounding the relief and recovery efforts.  Next, our spokesperson must be able to think on his or her feet.  And finally, we need to make sure our spokesperson has a trustworthy public image.","VS_T2P1S2_11.ogg"},
...
{"label","S3ASD1"},
 {"ns","What are you still doing here? Your task  is critical to the recovery of our city! We need to handle this oil spill crisis confidently, because the future of our entire ecosystem is in danger! Please, hurry back here after you've negotiated a deal with the spokesperson you selected!","VS_T1toW2PXS3_04.ogg"},
...
{"fun3",setvar,"scoreconvo","s3"},
 {"ns","You're back.  Are you here because you've negotiated a deal and need a contract for the person you selected as the spokesperson for the City?","VS_T2P1S3_01.ogg"},
...
{"label","S31C"},
{"fun",getcontractcost},
 {"ns","Okay, so I just need to plug in the numbers here, and we can have this contract ready for you right away.  Did you arrive at a final cost for the services being provided with the vendor you selected?","VS_T1toW2PXS3_02.ogg"},
...
{"fun3",setvar,"shorttrap",1},
 {"ns","Okay, that sounds about right.  Just give me a second to finish this…and…here you go! The next step is to bring this contract back to the spokesperson you selected and sign them up.  You can find the contract in your inventory.  You're not allowed to lose it!","VS_T1toW2PXS3_03.ogg"},
...
{"label","S4ASD1"},
 {"ns","What are you doing here?  We need be very careful not to lose time on unnecessary steps! You need to get that contract countersigned by the Mayor right away. Bring it back here after you are finished with her and I'll have further instructions. Are we clear?","VS_T1toT2PXS4_07.ogg"},
...
--**********************
	...
	--BAD JOB
	{"label","S41C"},
	 {"ns","There you are.   I heard you had some trouble with your task. Next time, just follow the guidelines closely and base your decisions on the research. Use the journal to take notes as you do your research and refer to it when you need to - it can be a big help.","VS_T1toT2PXS4_03.ogg"},
	...
	{"label","S42A"},
	 ...
	 {"pgs","Understood, Will.  What's next?","S42BAD","b"},
		...
		{"label","S42B"},
		 -- scorea:+LA
		 {"ns","To have a successful negotiation, you have to note everything you can about vendors' costs that you find during research.  The key to keeping costs down is being able to recall that information during your negotiation.  If you don't have you're facts straight, the vendor may try to raise their prices!","VS_T1toT2PXS4_05.ogg"},
