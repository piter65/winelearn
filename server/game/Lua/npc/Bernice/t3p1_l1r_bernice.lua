...
-- BChance: Broke up above label so that it works with the parser properly.
{"label","1_inc"},
    {"fun",incstandon},
    {"fun",incevelyn},
    {"goto","1A"},
...
{"label","2B"},
    ...
    {"pgs","That volunteer identification code looks funny to me.  I don’t think this is a legitimate badge.","2C","a"}, --GM+
    {"pgs","I think this badge looks legitimate.","2D","b"}, --GM-
