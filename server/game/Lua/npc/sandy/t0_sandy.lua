...
{"label","tut_sandy"},
	...
	{"ns","Hi! I'm Rachel and I'm glad you came by to talk to me.  I'm a professor of education at New City University and the city asked me to talk to teachers about the game.","Sandy1.wav"},

	{"pg","I'm a teacher, and I'm curious about the game and what I can do to help my students succeed.","sandy_start"},
	{"pg","Um, oh, sorry. I'm not really interested right now.","end"},

{"label","sandy_start"},


	{"ns","Great. That's the kind of attitude that makes this game worthwhile. So, to begin, the game takes place in New City. You see, there's been a terrible oil spill on the river and it is impacting the city's environment. The city has hired Professional Services, LLP to help with the recovery effort. That's where your students come in.","Sandy2.wav"},
...
{"ns","Well, if you haven't already done it, you should register on the website, then enroll your students, create teams and assign roles. You can do all that on the teacher portion of the website once you log in. Oh, and if you want to leave this room and look around New City, walk to the doormat with the arrow and click on it. Bye now.","Sandy13.wav"},
    {"pg","Thanks for your help! It sounds like a great program for both my students and for me.","end"},
