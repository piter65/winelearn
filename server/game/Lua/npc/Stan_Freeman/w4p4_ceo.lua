...
--POST CEO MEETING 1--
{"label","c1atd1b"},
    {"ns","Are you still here? We need to find out who is behind the tickets and bring that person to justice! Go to the Markdown Street Diner at once and see what you can find – but stop by City Hall first to find out what Will Standon has to say about all this!","vs_w4pxc1_11.wav"},
    {"pg","Okay, I'm on it.","end"},

{"label","c1atd1a"},
    {"ns","Well? You'd better get moving! We need to get to the bottom of this or the festival is doomed! We need to find out who is behind the phony tickets and bring that person to justice! Go to the Markdown Street Diner at once and see what you can find out!","vs_w4pxc1_10.wav"},
    {"pg","OK! I'm on it!","end"},
...
{"label","c13a"},
    {"ns","Hello? Yes? This is Stan... Excuse me? What!!?? Uh-huh... Okay... Well, I'm on it! Good bye! That was a ticket vendor, from right here in town. Now we know why ticket sales are down. Someone is selling counterfeit tickets!!  Apparently, there is somebody selling them at the Markdown Street Diner!","vs_w4pxc1_06.wav"},
...
{"label","c15a"},
    ...
    {"ns","Okay. Now, you should go ahead to the Markdown Street Diner and see what you can find out. But, before you go, go see Will Standon at City Hall.  If you can't find the counterfeiter right away, speak with your team mates to see if they can help make sense of the clues that you find.","vs_w4p4c1_01.wav"},
