...
namespace MaterialUI
{
    ...
    public class ShadowGen : MonoBehaviour
    {
        ...
        void ApplyChanges()
        {
            ...
            // BChance: (2016-01-20) - .NET 2.0 replacement for System.IO.File.WriteAllBytes(textureFileName, bytes);
            FileStream fs = new FileStream(textureFileName, FileMode.Create);
